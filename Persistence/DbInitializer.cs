...
{
    //async serve per operazione che potrebbe richiedere tempo, come chiamate a database o servizi esterni
    //in pratica fa in modo che aspetti il completamento di operazioni asincrone senza bloccare il thread principale
